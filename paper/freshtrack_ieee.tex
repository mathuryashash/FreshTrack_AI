...
% (figures/scan.pdf: python paper/make_scan_figure.py, from the repo root)
...
\IfFileExists{generated/app_numbers.tex}{\input{generated/app_numbers.tex}}{}
\input{generated/realworld_numbers.tex}
...
only as clearly labelled estimates. When it failed on real photos, we added a
deployment model and a two-stage scan that detects each item and classifies a
crop around it (Section~\ref{sec:phone}).
\end{enumerate}
...
%===========================================================================
\section{Deployment}
\IfFileExists{sections/deployment.tex}{\input{sections/deployment.tex}}{}

%===========================================================================
\section{From Benchmark to Phone Photos}\label{sec:phone}
\input{sections/phone.tex}
